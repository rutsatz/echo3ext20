...
Ext.ux.Multiselect = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		if (this.legend) {
			fsOptions.title = this.legend;
		}

		fs = new Ext.form.FieldSet(fsOptions);
...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
	...
	hideNavIcons:false,
	imagePath:"",
	iconUp:"resources/ext/images/multiselect/up2.gif",
	iconDown:"resources/ext/images/multiselect/down2.gif",
	iconLeft:"resources/ext/images/multiselect/left2.gif",
	iconRight:"resources/ext/images/multiselect/right2.gif",
	iconTop:"resources/ext/images/multiselect/top2.gif",
	iconBottom:"resources/ext/images/multiselect/bottom2.gif",
	drawUpIcon:true,
	drawDownIcon:true,
	drawLeftIcon:true,
	drawRightIcon:true,
