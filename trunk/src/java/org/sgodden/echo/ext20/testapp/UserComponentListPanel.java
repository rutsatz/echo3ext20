...
public class UserComponentListPanel
        extends Panel {

    private static final transient Log LOG = LogFactory.getLog(UserComponentListPanel.class);
    private ComponentGridPanel userGridPanel;
     ...
     * @return
     */
    public ComponentGridPanel getGridPanel() {
        return userGridPanel;
    }
    
    private ComponentGridPanel makeGridPanel() {
        
        userGridPanel = new ComponentGridPanel(makeColumnModel());
