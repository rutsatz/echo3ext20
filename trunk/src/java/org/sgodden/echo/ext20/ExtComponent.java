...
public abstract class ExtComponent extends Component {
     ...
     */
    public static final String PROPERTY_CONTAINER_CSS_CLASS = "containerCssClass";

    /**
     * The effect to apply when the component is added to it's parent container
     */
    public static final String PROPERTY_CONTAINER_ADD_EFFECTS = "containerAddFx";

    /**
     * The effect to apply when the component will be removed from it's parent
     * container
     */
    public static final String PROPERTY_CONTAINER_REMOVE_EFFECTS = "containerRemoveFx";
     ...
     * The tooltip to apply to any ext component.
     */
    public static final String PROPERTY_SHOW_TOOL_TIP = "showToolTip";
    ...
    public boolean getClosable() {
        Object val = get(PROPERTY_CLOSABLE);
        return val == null ? Boolean.FALSE : (Boolean) val;
    }

    public void setClosable(boolean closable) {
        set(PROPERTY_CLOSABLE, Boolean.valueOf(closable));
    }
    ...
    public void setContainerCssClass(String cls) {
        set(PROPERTY_CONTAINER_CSS_CLASS, cls);
    }

    public String getContainerCssClass() {
        return (String) get(PROPERTY_CONTAINER_CSS_CLASS);
    }
    ...
    public void setAddEffect(AddComponentFx effect) {
        addEffect = effect;
        set(PROPERTY_CONTAINER_ADD_EFFECTS, addEffect.toString());
    }
    ...
    public void setRemoveEffect(RemoveComponentFx effect) {
        removeEffect = effect;
        set(PROPERTY_CONTAINER_REMOVE_EFFECTS, removeEffect.toString());
    }

    public void setToolTip(String toolTip) {
        set(PROPERTY_TOOL_TIP, toolTip);
        //if we have set the tooltip on a component then it should be visible
        setShowToolTip(true);
    }

    public void setShowToolTip(boolean showToolTip) {
        set(PROPERTY_SHOW_TOOL_TIP, showToolTip);
    }
