// Note - following text included for clarity of licensing issues
/*
 ...
 */
Ext.ux.ColumnLayout = Ext.extend(Ext.layout.ContainerLayout, {
    // private
    monitorResize:true,
    // private
    extraCls: 'x-column',
...
//          allow space in calculations for splitbars.
        ...
        Ext.ux.ColumnLayout.superclass.renderAll.apply(this, arguments);
    },
...
//      How much space there is to expand into.
    ...
    onResize: function() {
        ...
        Ext.ux.ColumnLayout.superclass.onResize.apply(this, arguments);
    }
...
Ext.Container.LAYOUTS['fitcolumn'] = Ext.ux.ColumnLayout;