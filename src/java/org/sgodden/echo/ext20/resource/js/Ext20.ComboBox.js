...
//                }
   ...
   _handleExpandEvent: function() {
    ...
    /** Set the width of the combo box selector field as opposed to the width of the
     *  drop down list of values to select which is dealt with by the listWidth property
    */
    _setSelectorWidth: function() {
       if (this.component.get("width") && this.component.get("width") != "auto") {
           var textFieldWidth = this.component.get("width")+"px";
