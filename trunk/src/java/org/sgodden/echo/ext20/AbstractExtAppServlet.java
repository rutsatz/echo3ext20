...
public abstract class AbstractExtAppServlet extends WebContainerServlet {
    ...
    private static final Service aarCkRichTextService;
    ...
    static {
        ...
        aarCkRichTextService = new JavaScriptService("Aar.Ckeditor", Resource.getResourceAsString("resource/js/Aar.Ckeditor.js"));
    ...
    public AbstractExtAppServlet() {
        ...
        addInitScript(aarCkRichTextService);
